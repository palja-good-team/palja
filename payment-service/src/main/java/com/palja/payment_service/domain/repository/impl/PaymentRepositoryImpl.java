package com.palja.payment_service.domain.repository.impl;
...
import com.palja.payment_service.infrastructure.repository.PaymentJpaRepository;
...
public class PaymentRepositoryImpl implements PaymentRepository {
    ...
    public Optional<Payment> findById(UUID id) {
        return Optional.ofNullable(paymentJpaRepository.findById(id).orElse(null));
    }
